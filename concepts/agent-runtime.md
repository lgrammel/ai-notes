...
Agent runtimes often handle orchestration concerns such as tool routing, retries, concurrency, memory/persistence, timeouts/cancellation, [tool execution approval](./tool-execution-approval.md), and integration with a [sandbox](./sandbox.md) and [observability](./observability.md).
