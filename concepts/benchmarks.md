...
Open-ended benchmarks (e.g., MT-Bench, AlpacaEval) increasingly use [model-as-a-judge](./model-as-a-judge.md) scoring where fixed-answer evaluation is impractical.
