...
- Structuring repository-level agent instructions as a short entry point pointing to deeper knowledge rather than a monolithic file ([progressive context disclosure](../ideas/agent-legibility.md)).
