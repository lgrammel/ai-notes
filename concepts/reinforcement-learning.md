...
RL-trained behaviors - instruction following, reasoning depth, safety refusals - are baked into model weights and define the baseline behavior that [prompt engineering](./prompt-engineering.md) and [context engineering](./context-engineering.md) build on.
