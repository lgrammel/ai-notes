...
The transformer architecture is a neural network design for sequence modeling built around attention (especially self-attention). It is the architecture underlying virtually all current [LLMs](./llm.md) and [embedding models](./embedding-model.md), established during [pretraining](./pretraining.md).
