...
A customer-facing [chatbot](../concepts/conversational-interface.md) that combines a [multi-turn](../concepts/multi-turn-conversation.md) [agent](../concepts/agent.md) loop with [agentic RAG](../concepts/agentic-rag.md) over a knowledge base and schema-constrained business API [tools](../concepts/tools.md) for real-world actions like refunds, order modifications, and account changes. [Human-in-the-loop](../concepts/human-in-the-loop.md) escalation routes complex or sensitive cases to human agents.
