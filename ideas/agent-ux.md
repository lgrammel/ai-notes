...
Agent UX addresses usability once an offering is already known to the agent; [agent SEO](./agent-seo.md) addresses the complementary problem of ranking well in agent-mediated search and discovery. Together they represent two sides of the same adoption problem: an offering must be both discoverable and easy to use correctly.
