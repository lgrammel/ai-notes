...
Agent UX addresses usability once an offering is already known to the agent; [agent SEO](./agent-seo.md) addresses the prior problem of making the offering discoverable in the first place. Together they represent two sides of the same adoption problem: an offering must be both findable and easy to use correctly.
