...
- A semantic cache returns a cached LLM response generated from one customer's proprietary documents to a different customer whose query has a similar embedding.
