...
- Resource limits on compute, API [quotas](../concepts/quota-management.md), and cost
- Bounded iteration limits on [tool](../concepts/tools.md) call loops and [reasoning](../concepts/reasoning.md) chains
- [Rate limiting](../concepts/rate-limiting.md) on incoming requests to prevent flooding
